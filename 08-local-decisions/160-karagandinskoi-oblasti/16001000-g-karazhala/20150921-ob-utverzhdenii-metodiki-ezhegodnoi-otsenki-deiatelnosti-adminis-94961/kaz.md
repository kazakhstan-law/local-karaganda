---
version_id: '94961_29160'
act_code: '94961'
language: kaz
title: «Қаражал қалалық мәслихат аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін жыл сайынғы  бағалау әдістемесін бекіту туралы
requisite: Қарағанды облысы Қаражал қалалық мәслихатының 2015 жылғы 21 қыркүйектегі XXXXII сессиясының № 357 шешімі. Қарағанды облысының Әділет департаментінде 2015 жылғы 26 қазанда № 3461 болып тіркелді. Күші жойылды - Қарағанды облысы Қаражал қалалық мәслихатының ХXXXVIII сессиясының  2016 жылғы 19 ақпандағы N 411
form: РЕШ
type_codes:
- МЕТ
- РЕШ
...
source: https://zan.gov.kz/client/#!/doc/94961/kaz/21.09.2015
---

# «Қаражал қалалық мәслихат аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін жыл сайынғы бағалау әдістемесін бекіту туралы

Қазақстан Республикасының 1999 жылғы 23 шілдедегі «Мемлекеттік қызмет туралы» Заңына, Қазақстан Республикасы Президентінің 2000 жылғы 21 қаңтардағы № 327 «Мемлекеттік әкімшілік қызметшілердің қызметіне жыл сайынғы бағалау жүргізу және оларды аттестаттаудан өткізу қағидаларын бекіту туралы» Жарлығына, Қазақстан Республикасының Мемлекеттік қызмет істері және сыбайлас жемқорлыққа қарсы іс-қимыл агенттігі төрағасының 2014 жылғы 29 желтоқсандағы № 86 «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін жыл сайынғы бағалаудың үлгілік әдістемесін бекіту туралы» (нормативтік құқықтық актілердің мемлекеттік тіркеу Тізілімінде № 10130 болып тіркелген) бұйрығына сәйкес, қалалық мәслихат ШЕШІМ ЕТТІ:

1. Қоса беріліп отырған «Қаражал қалалық мәслихат аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін жыл сайынғы бағалау әдістемесі бекітілсін.

2. Осы шешімнің орындалуын бақылау Қаражал қалалық мәслихат аппаратының басшысына жүктелсін.

3. Осы шешім оның алғаш ресми жарияланған күнінен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі.

**ХХХХІІ сессияның төрағасы, қалалық мәслихаттың хатшысы**
...
# «Қаражал қалалық мәслихат аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін жыл сайынғы бағалау әдістемесі

## 1. Жалпы ережелер

1. Осы «Қаражал қалалық мәслихат аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін жыл сайынғы бағалаудың әдістемесі Қазақстан Республикасы Президентінің 2000 жылғы 21 қаңтардағы № 327 «Мемлекеттік әкімшілік қызметшілердің қызметіне жыл сайынғы бағалау жүргізу және оларды аттестаттаудан өткізу қағидаларын бекіту туралы» Жарлығын іске асыру үшін әзірленді және «Қаражал қалалық мәслихат аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің (бұдан әрі – қызметшілер) қызметіне жыл сайынғы бағалау жүргізу тәсілін айқындайды.
...
10. Дауыс беру қорытындысы Комиссия мүшелерінің көпшілік дауысымен айқындалады. Дауыс саны тең болған жағдайда, комиссия төрағасының дауысы шешуші болып табылады.
    ...
    Комиссия хатшысы болып персоналды басқару қызметінің маманы (бұдан әрі – Комиссия хатшысы) табылады. Комиссия хатшысы дауыс беруге қатыспайды.
...
12. Тікелей басшы осы Әдістеменің 1-қосымшасына сәйкес нысан бойынша бағалау парағын Комиссия хатшысынан алған күннен бастап үш жұмыс күн ішінде толтырады, қызметшіні толтырылған бағалау парағымен таныстырады және екі жұмыс күні ішінде толтырылған бағалау парағын Комиссия хатшысына қайтарады.
...
16. Комиссия хатшысы осы Әдістеменің 13-тармағында көрсетілген тұлғалардың бағалауының орта есептелуін жүзеге асырады.
...
21. Комиссия бағалау нәтижелерін қарастырады және мына шешімдердің бірін шығарады:
    ...
    2) бағалау нәтижелерін қайта қарайды.
       ...
       персоналды басқару қызметінің маманымен бағалау нәтижесін санауда қате жіберілсе.
...
Т.А.Ә. ______________________		        Т.А.Ә. ____________________
күні ________________________		        күні ______________________
қолы _______________________		        қолы _____________________
```
